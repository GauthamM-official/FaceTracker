...
import com.google.android.gms.samples.vision.face.facetracker.ProjectActivity;
...
public class GraphicOverlay extends View {
    ...
    public static abstract class Graphic {
         ...
         */
        public abstract void draw(Resources resources,Canvas canvas, String text);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        synchronized (mLock) {
            ...
            for (Graphic graphic : mGraphics) {
                graphic.draw(getResources(), canvas, projectActivity.gettext());
            }
        }
    }
}